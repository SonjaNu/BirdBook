...
public class BirdController {
	...
	//RESTful service --> hakee yhden linnun id:n mukaan, muuttaa javasta JSON:iksi
	 ...
	 @PreAuthorize(value = "hasAuthority('ADMIN')") //vain admin-roolissa voi muokata lintua
	 ...
	 public String editBird(@PathVariable("id") long birdId, Model model) {
	     ...
	     model.addAttribute("categories", categoryRepository.findAll());
	     return "editBird";
	     //jos linnun id on 0 tai null, tehdään sql insert, muuten tehdään sql update
	 }	
	 ...
	 @GetMapping("/")
	 public String birdlist() { // asettaa endpointin kielen vaihdosta varten
	     return "birdlist"; 
	 }
